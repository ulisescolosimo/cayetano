      ...
      >
        <div className="bg-white/90 backdrop-blur-sm rounded-[20px] p-6 sm:p-8 shadow-xl border border-gray-100">
          <div className="text-center mb-6">
            ...
            <h1 className="font-display text-[28px] sm:text-[32px] font-normal text-gray-800 mb-1 leading-tight">
              Tu aporte fue recibido
            </h1>
            <p className="font-sans text-sm text-gray-600">
              Creá tu cuenta con el mismo correo para acceder a la zona de miembros.
            </p>
          </div>
...
export default function AporteExitosoPage() {
  return (
    <Suspense fallback={
      <div className="min-h-screen flex items-center justify-center bg-white">
